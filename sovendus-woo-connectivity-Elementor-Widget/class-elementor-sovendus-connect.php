 ...
 *
 *
 * The init class that runs the Elementor Sovendus plugin.
 ...
 */
final class Elementor_Sovendus {
	...
	public function i18n() {
		load_plugin_textdomain( 'sovendus-connectivity' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( Elementor_Sovendus ) );
...
// Instantiate Elementor_Sovendus.
new Elementor_Sovendus();
